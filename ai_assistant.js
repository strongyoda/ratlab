...
갈림길: 체중만 재는 날→「물·사료 안 채우고 그대로 둠」 체크(빠뜨리면 다음 구간 섭취량 부풀려짐) · 한쪽만 가는 날→「물 그대로 둠」/「사료 그대로 둠」 · 통 번호 잃음→짝 추측 금지, 「이상」 체크로 구간 제외 · 사망→개체 칸 「사망」 체크 한 번(계획된 희생은 일괄 입력) · 누수·엎어짐→「이상」 · MR 찍은 날→「MR 촬영」(잔량 안 잼) · BP 잰 날→「혈압 측정」(잔량 평소대로 재고 기록, 몇 시간 물을 못 마셔 낮은 값이라 농도 산정에서만 제외) · 수술한 날→「수술」(잔량 재고 기록, 농도 산정에서만 제외).
